...
contract Lottery is VRFConsumerBase , Ownable{
    ...
    AggregatorV3Interface internal ethUsdProceFeed;
    enum LOTTERY_STATE{
        OPEN,
        CLOSED,
        CALCULATING_WINNER
    ...
    constructor (
        ...
        ethUsdProceFeed = AggregatorV3Interface(_priceFeedAddress);
    ...
    function getEntranceFee() public view returns (uint256) {
       ...
       (
        ...
        ) = ethUsdProceFeed.latestRoundData();
        require(price!=0, "message to be displayed");
